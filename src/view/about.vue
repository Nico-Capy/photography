<template>
  <div class="flex flex-col items-center justify-center">
    <h2 class="dwight text-3xl text-white drop-shadow-xl m-6 mb-0">{{$t('about.title')}}</h2>
    <div class="mx-auto flex flex-row m-2 mt-6 w-10/12 items-center text-center dwight">
      <h3 class="text-3xl text-white indent-14 drop-shadow-xl">{{$t('about.subtitle.start')}}<a href="https://www.youtube.com/watch?v=5rr0zAtdEvw" target="_blank" rel="noopener noreferrer"><span class="dwight text-3xl text-black bg-white px-3 ml-1 shadow cursor-pointer">Nico</span></a></h3>
    </div>
