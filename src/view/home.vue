<template>
  ...
  <div class="flex justify-center bg-transparent h-2/3">
    <div class="bg-transparent w-3/4 lg:w-screen xl:w-screen 2xl:w-screen p-3 mb-16 flex flex-col justify-center items-center drop-shadow-lg" style="height: 63vh;">
